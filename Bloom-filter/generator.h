...
void generateData(dtype* &data, unsigned long long no_stream, unsigned long long no_unique, int distNum, double zipfAlp) {
	...
	if (distNum == NORMAL)
	{
		//  cout << "normal " << endl;
		double alp = zipfAlp;
		cout << "Zipfian Distribution is: " << zipfAlp << endl;
		zipf(alp, no_unique);
